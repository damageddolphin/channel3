...
## Retun Values
    return(observationLocation, observationTime, currentSkys, currentTemperature, currentDewpoint, currentHeatIndex, currentWind, currentWindGusts, currentHumidity, currentPressure, currentVisibility, weatherCredit)
